    ...
    <section className="h-[70vh] bg-hero bg-no-repeat bg-cover bg-center relative">
      ...
      <div className="container mx-auto h-full flex items-center">
        <div className="z-20 text-white text-center xl:text-left mx-auto xl:mx-0 flex flex-col items-center xl:items-start max-w-[608px]">
          ...
          >
            <span className="text-accent">Издръжливост</span> и стил, изляти
            в бетон
          </motion.h1>
          <motion.p
            ...
            className="mb-9"
          >
            От концепция до завършване, ние гарантираме, че всеки детайл е
            оптимизиран за здравина и издръжливост, създавайки решения, които
            вдъхват доверие и остават непокътнати с години.
          </motion.p>
          {/* btn */}
          <motion.div
            variants={fadeIn("up", 0.4)}

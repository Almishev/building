    ...
    <section className="pt-16 xl:pt-32">
      <div className="container mx-auto">
        <div className="flex flex-col xl:flex-row relative">
          ...
          >
            <Pretitle text="Отзиви от клиенти" />
            <h2 className="h2 mb-6">Изградено с доверие, доказано с резултати</h2>
            <p className="mb-10 max-w-[420px]">
              Нашите клиенти споделят своя опит от работата си с нас - от
